from agent import Status, DecoyAgent
import logging
...
class BehaviorService:
    ...
    def drop_decoy_found(self,agent,decoys):
        if agent.found_state and agent.load_state:
